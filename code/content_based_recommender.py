...
def set_recommender(genre, name, duration, score, episodes, source):
    ...
    cluster_dataset = cluster_dataset.drop(columns=['Rating', 'Producers_format', 'Studios_format', 'Type_format', 'Rating_format', 'Name_format'])
    ...
    row_utente = [score, episodes, duration, genre_format, source_format]
    ...
    similarity_dataset = cluster_dataset.drop(columns=['cluster'])
   ...
   # print("name: ", name_dic)
    ...
    first_10_similarity['Name_format'] = first_10_similarity.iloc[:, [4]]

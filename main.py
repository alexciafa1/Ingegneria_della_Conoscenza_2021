...
metrics.confusionMatrix(y_test, prediction, group_names, name=' Confusion Matrix KNN')
print("\n\n")
...
metrics.confusionMatrix(y_test, prediction,group_names, name='Confusion Matrix Bayes')
print("\n\n")
...
print(classifier3)
metrics.validation(y_test, prediction)
metrics.confusionMatrix(y_test, prediction,group_names, name='Confusion Matrix SVM')
print("\n\n")
...
print(classifier4)
metrics.validation(y_test, prediction)
metrics.confusionMatrix(y_test, prediction,group_names, name='Confusion Matrix RFC')
print("\n\n")
